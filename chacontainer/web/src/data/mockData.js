...
export const containers = [
  { id: 'CHC-0421', type: 'Tarima/Pallet (CHA6548-50)', status: 'disponible', location: 'Bodega Estado de México', client: 'Bosch', washes: 12, lastEvent: '2026-05-15 08:32', lat: 19.6465, lng: -99.1968 },
  { id: 'CHC-0422', type: 'Tarima/Pallet (CHA6548-44)', status: 'en_lavado', location: 'Taller Querétaro', client: 'Valeo México', washes: 8, lastEvent: '2026-05-15 11:20', lat: 20.5888, lng: -100.3899 },
  { id: 'CHC-0423', type: 'KLT (CHA3032-25)', status: 'en_transito', location: 'Ruta Querétaro–CDMX', client: 'Denso', washes: 15, lastEvent: '2026-05-15 09:45', lat: 20.10, lng: -99.90 },
  { id: 'CHC-0424', type: 'Contenedor Colapsable (CHA4845-42)', status: 'en_reparacion', location: 'Taller Puebla', client: 'Continental', washes: 22, lastEvent: '2026-05-14 16:10', lat: 19.0414, lng: -98.2063 },
  { id: 'CHC-0425', type: 'Tarima/Pallet (CHA6548-50)', status: 'no_conforme', location: 'Bodega Puebla', client: 'Bosch', washes: 31, lastEvent: '2026-05-13 14:55', lat: 19.0414, lng: -98.2063 },
  { id: 'CHC-0426', type: 'KLT (CHA3032-34)', status: 'asignado', location: 'Planta Cliente Puebla', client: 'Draexlmaier', washes: 5, lastEvent: '2026-05-15 07:30', lat: 19.03, lng: -98.19 },
  ...
  { id: 'CHC-0428', type: 'Tarima/Pallet (CHA6548-50)', status: 'perdido', location: 'Desconocido', client: 'Valeo México', washes: 18, lastEvent: '2026-05-10 09:00', lat: null, lng: null },
  ...
  { id: 'CHC-0430', type: 'KLT (CHA3032-25)', status: 'en_lavado', location: 'Taller Villa de Reyes', client: 'Draexlmaier', washes: 11, lastEvent: '2026-05-15 10:00', lat: 21.8078, lng: -100.9271 },
  { id: 'CHC-0431', type: 'Rack Metálico (CHA64.548-34)', status: 'asignado', location: 'Planta Cliente Toluca', client: 'Bosch', washes: 6, lastEvent: '2026-05-15 08:00', lat: 19.2826, lng: -99.6557 },
  { id: 'CHC-0432', type: 'Contenedor Colapsable (CHA4845-34)', status: 'en_transito', location: 'Ruta San Luis Potosí–Querétaro', client: 'Denso', washes: 9, lastEvent: '2026-05-15 05:30', lat: 22.1565, lng: -100.9855 },
  ...
  { id: 'CHC-0434', type: 'Charola (CHA7048-50)', status: 'en_reparacion', location: 'Taller Querétaro', client: 'Continental', washes: 27, lastEvent: '2026-05-14 11:45', lat: 20.5888, lng: -100.3899 },
  ...
  { id: 'CHC-0436', type: 'Rack Metálico (CHA64.548-25)', status: 'asignado', location: 'Planta Cliente Guanajuato', client: 'Continental', washes: 19, lastEvent: '2026-05-15 07:00', lat: 21.0190, lng: -101.2574 },
  { id: 'CHC-0437', type: 'Contenedor Colapsable (CHA4845-42)', status: 'no_conforme', location: 'Bodega Estado de México', client: 'Valeo México', washes: 33, lastEvent: '2026-05-12 14:00', lat: 19.6465, lng: -99.1968 },
  { id: 'CHC-0438', type: 'Separador (CHA7848-34)', status: 'en_lavado', location: 'Taller Puebla', client: 'Denso', washes: 10, lastEvent: '2026-05-15 09:15', lat: 19.0414, lng: -98.2063 },
  ...
  { id: 'CHC-0440', type: 'Contenedor / Caja Rígida (CHA4857-34)', status: 'en_transito', location: 'Ruta Puebla–Villa de Reyes', client: 'Draexlmaier', washes: 8, lastEvent: '2026-05-15 08:30', lat: 20.42, lng: -99.57 },
]

// Nota: Bosch, Valeo México, Denso, Continental y Draexlmaier son prospectos/objetivos
// reales del pipeline comercial (Tier 1 automotriz, parque Bernardo Quintana, Querétaro).
// Todavía no son clientes activos — son ejemplos con nombre real para la demo, no facturación real.
...
export const containerEvents = {
  'CHC-0421': [
    ...
    { time: '2026-05-13 14:30', event: 'Devolución Cliente', detail: 'Bosch Planta Toluca → Taller', user: 'Transportes XY' },
  ],
  'CHC-0422': [
    { time: '2026-05-15 11:20', event: 'En Lavado', detail: 'Taller Querétaro - Iniciado ciclo 9', user: 'Operador M.' },
    { time: '2026-05-15 09:45', event: 'Ingreso Taller', detail: 'Devolución Valeo México Querétaro', user: 'Camión XYZ-123' },
    { time: '2026-05-10 08:00', event: 'Despacho', detail: 'Enviado a Valeo México Querétaro', user: 'Sistema' },
  ],
  'CHC-0428': [
    { time: '2026-05-10 09:00', event: 'Último Escaneo', detail: 'Valeo México Planta Estado de México - Ingreso', user: 'Guardia Valeo México' },
...
export const projects = [
  { id: 'PRJ-001', name: 'Migración Embalaje Bosch Planta Toluca', client: 'Bosch', manager: 'Andrea Vásquez', status: 'en_curso', phase: 3, totalPhases: 5, startDate: '2026-03-01', endDate: '2026-07-30', budget: 45000000, spent: 28500000, containers: 180, risk: 'medio' },
  { id: 'PRJ-002', name: 'Implementación Contenedores Valeo México Querétaro', client: 'Valeo México', manager: 'Carlos Muñoz', status: 'en_curso', phase: 2, totalPhases: 4, startDate: '2026-04-15', endDate: '2026-09-15', budget: 32000000, spent: 12800000, containers: 120, risk: 'bajo' },
  { id: 'PRJ-003', name: 'Piloto Tarimas Denso Puebla', client: 'Denso', manager: 'María Torres', status: 'propuesta', phase: 1, totalPhases: 3, startDate: '2026-06-01', endDate: '2026-10-31', budget: 18000000, spent: 0, containers: 300, risk: 'alto' },
  { id: 'PRJ-004', name: 'Renovación Flota Continental Guanajuato', client: 'Continental', manager: 'Roberto Silva', status: 'cerrado', phase: 5, totalPhases: 5, startDate: '2025-09-01', endDate: '2026-03-31', budget: 28000000, spent: 27200000, containers: 95, risk: 'bajo' },
  { id: 'PRJ-005', name: 'Expansión Draexlmaier Villa de Reyes', client: 'Draexlmaier', manager: 'Andrea Vásquez', status: 'en_curso', phase: 1, totalPhases: 6, startDate: '2026-05-01', endDate: '2026-12-31', budget: 55000000, spent: 4200000, containers: 250, risk: 'medio' },
  { id: 'PRJ-006', name: 'Evaluación Contenedores Valeo México Estado de México', client: 'Valeo México', manager: 'Carlos Muñoz', status: 'propuesta', phase: 1, totalPhases: 4, startDate: '2026-07-01', endDate: '2027-01-31', budget: 22000000, spent: 0, containers: 80, risk: 'bajo' },
]
...
export const alerts = [
  ...
  { id: 'A004', type: 'advertencia', message: 'PRJ-003 Denso: aprobación pendiente hace 3 días', module: 'proyectos', time: '08:20' },
...
export const recentActivity = [
  ...
  { time: '11:38', event: 'Pedido Creado', detail: 'ORD-2851: 20x Tarima/Pallet → Bosch Toluca', user: 'Sistema' },
  ...
  { time: '10:55', event: 'Despacho', detail: 'ORD-2847: 15x Contenedor Colapsable → Continental Guanajuato', user: 'Sistema' },
