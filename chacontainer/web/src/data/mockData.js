...
export const ads = [
  {
    ...
    type: 'venta',
    category: 'IBC',
    title: 'IBC 1000L Grado Alimenticio — Lote 20 unidades',
    description: 'Lote de 20 IBCs 1000L lavados y certificados, disponibles de inmediato. Ideal para industria alimenticia. Certificación FDA. Excelente estado.',
    price: 270000,
    unit: 'unidad',
    quantity: 20,
    location: 'Santiago, RM',
    company: 'InduQuím S.A.',
    contact: 'contacto@induquim.cl',
  ...
  },
  {
    ...
    type: 'compra',
    category: 'Tambores',
    title: 'Se busca Tambores 200L HDPE — mínimo 100 un',
    description: 'Empresa minera requiere tambores 200L HDPE para transporte de reactivos. Condición: nuevos o reutilizados en buen estado con certificación vigente.',
    price: null,
    unit: 'unidad',
    quantity: 100,
    location: 'Antofagasta, II',
    company: 'Minera Atacama Ltda.',
    contact: 'compras@mineraatacama.cl',
  ...
  },
  {
    ...
    type: 'venta',
    category: 'IBC',
    title: 'IBC 600L Industrial — disponibilidad inmediata',
    description: 'Se venden 12 IBCs 600L industriales. Lavados y en buen estado operacional. Precio negociable para compras en volumen. Entrega en planta.',
    price: 185000,
    unit: 'unidad',
    quantity: 12,
    location: 'Concepción, VIII',
    company: 'Embalajes del Sur S.A.',
    contact: 'ventas@embsur.cl',
  ...
  },
  {
    ...
    type: 'servicio',
    category: 'Servicios',
    title: 'Servicio de lavado especializado IBC — turno rápido 48 h',
    description: 'Ofrecemos lavado certificado de IBCs con tiempo de ciclo de 48 horas. Taller habilitado, personal calificado. Atendemos Región Metropolitana y V Región.',
    price: 25000,
    unit: 'unidad',
    quantity: null,
    location: 'Santiago / Valparaíso',
    company: 'CleanPack Chile',
    contact: 'ops@cleanpack.cl',
  ...
  },
  {
    ...
    type: 'compra',
    category: 'Pallets',
    title: 'Compra pallets reutilizables estándar — volumen',
    description: 'Planta logística requiere pallets reutilizables EUR estándar (1200x800). Pedido inicial 500 unidades con posibilidad de contrato trimestral.',
    price: null,
    unit: 'unidad',
    quantity: 500,
    location: 'Valparaíso, V',
    company: 'LogiPort S.A.',
    contact: 'abastecimiento@logiport.cl',
  ...
  },
  {
    ...
    type: 'venta',
    category: 'Tambores',
    title: 'Tambores 220L Metálicos — lote 50 un.',
    description: 'Lote de 50 tambores 220L metálicos en buen estado. Aptos para almacenamiento de productos petroquímicos. Documentación completa disponible.',
    price: 48000,
    unit: 'unidad',
    quantity: 50,
    location: 'Rancagua, VI',
    company: 'Petro Industrial Ltda.',
    contact: 'stock@petroindustrial.cl',
  ...
  },
  {
    ...
    type: 'servicio',
    category: 'Servicios',
    title: 'Reparación y recertificación de IBCs — precio por volumen',
    description: 'Taller especializado en reparación estructural y recertificación de IBCs. Aceptamos desde 5 unidades. Informe técnico incluido. Cobertura nacional.',
    price: 58000,
    unit: 'unidad',
    quantity: null,
    location: 'Nacional',
    company: 'TecnoIBC Chile',
    contact: 'reparaciones@tecnoibc.cl',
    phone: '+56 2 2111 3333',
    postedAt: '2026-06-13',
    urgent: false,
  },
  {
    ...
    type: 'compra',
    category: 'IBC',
    title: 'Urgente: IBC 1000L Grado Químico — entrega inmediata',
    description: 'Industria química requiere con urgencia 30 IBCs 1000L grado químico. Certificación ADR preferida. Se evalúan ofertas en todas las regiones.',
    price: null,
    unit: 'unidad',
    quantity: 30,
    location: 'A convenir',
    company: 'QuimSol S.A.',
    contact: 'urgente@quimsol.cl',
